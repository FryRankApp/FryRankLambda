...
public class DeleteReviewInfoValidator implements Validator {
    ...
    public boolean supports(@NonNull Class<?> clazz) {
        return DeleteReviewInfo.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(@NonNull Object target, @NonNull Errors errors) {
        DeleteReviewInfo deleteReviewInfo = (DeleteReviewInfo) target;
