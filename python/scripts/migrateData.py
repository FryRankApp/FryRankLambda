...
def main():
    ...
    MONGODB_USER_METADATA_TABLE_NAME = os.getenv('')
    MONGODB_REVIEW_TABLE_NAME = os.getenv('')
    DYNAMODB_USER_METADATA_TABLE_NAME = os.getenv('')
    DYNAMODB_REVIEW_TABLE_NAME = os.getenv('')
